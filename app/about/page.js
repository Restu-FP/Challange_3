    ...
    <div className="max-w-3xl mx-auto p-6 sm:p-8 bg-white shadow-lg rounded-lg">
      <div className="flex flex-col md:flex-row items-center gap-8">
        ...
        <div className="text-center md:text-left">
          <h1 className="text-4xl font-bold text-gray-900">Restu Fajar Pratama</h1>
          <p className="text-xl text-gray-600 opacity-90">Mahasiswa Sistem Informasi</p>
        </div>
      </div>
      ...
      <div className="mt-8">
        ...
        <p className="text-gray-700 mt-2 text-lg">
          ...
          ketertarikan dalam pengembangan web dan teknologi modern.
        </p>
      </div>
      ...
      <div className="mt-8">
        ...
        <div className="flex flex-col gap-4 mt-4">
          <p className="flex items-center gap-3 text-lg text-gray-700">
            ...
            <a href="mailto:restufajarpratama69@gmail.com" className="hover:text-blue-800 transition-colors">
              restufajarpratama69@gmail.com
            </a>
          </p>
          <p className="flex items-center gap-3 text-lg text-gray-700">
            <Phone className="w-6 h-6 text-blue-600" /> 
            <a href="tel:+6285700648159" className="hover:text-blue-800 transition-colors">
              +62 857-0064-8159
            </a>
          </p>
        </div>
